def readfile(fichier):
    try:
        ...
        print("le fichier en question n'existe pas\n.")
       
lire=readfile('C:/Users/ASUS/Desktop/R109/Exam.txt')
fichiercsv=[]
fic=open("C:/Users/ASUS/Desktop/R109/tramesé.csv", "w",encoding="utf8")            
